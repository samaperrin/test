...
#Overlay river network by major watersheds / catchments (for limiting connectivity analysis to within catchment connectivity)
...
#Overlay lakes by major watersheds / catchments (for limiting connectivity analysis to within catchment connectivity)
#remove  "WHERE vassomr = '123'" in order to run on the entire dataset
...
###Perform network analysis using igraph package in R
